...
namespace PredictiveMaintenanceConsole
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Projects\PredictiveMaintenance\PredictiveMaintenance\ai4i2020.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=9,MinimumExampleCountPerLeaf=20,NumberOfTrees=5,MaximumBinCountPerFeature=456,FeatureFraction=0.9251769146155902,LearningRate=0.12577050993844177,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Machine failure"))      
